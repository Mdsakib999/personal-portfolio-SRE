        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <span className="text-2xl md:text-3xl font-bold tracking-tight text-white">sr.</span>
            </div>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <nav aria-label="Our projects" className="md:col-span-1">
            <h4 className="text-lg font-semibold text-gray-300 mb-4">Our projects</h4>
            <ul className="space-y-3 text-gray-300">
              <li>
                <Link href="#" className="hover:text-white">SM Travels</Link>
              </li>
              <li>
                <Link href="#" className="hover:text-white">SM Foods</Link>
              </li>
              <li>
                <Link href="#" className="hover:text-white">SM Auto</Link>
              </li>
            </ul>
          </nav>
          {/* Follow us */}
        ...
        <div className="mt-10 border-t border-white/6 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400">© 2025 Shahriar Rahman. All rights reserved.</p>
